...
from sam.queries.notice_links import (
    MANAGE_PROJECT_PATH, ONBOARDING_PATHS, RESOURCE_DETAILS_PATH)
...
def test_every_linked_path_is_a_route():
    ...
    assert '/' + MANAGE_PROJECT_PATH.format(projcode='<projcode>') in rules
