...
ALLOWED_VIOLATIONS = {
    ...
    'dashboards/admin/fragments/institutions_table.html': {'inline_scripts': 1, 'event_handlers': 1},
    'dashboards/admin/fragments/organization_card.html': {'inline_scripts': 1, 'event_handlers': 1},
    ...
    'dashboards/status/partials/nodetype_table.html': {'event_handlers': 1},
    'dashboards/status/partials/queue_table.html': {'event_handlers': 1},
    'dashboards/user/fragments/allocation_modals.html': {'inline_scripts': 1},
