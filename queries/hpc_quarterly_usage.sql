...
-- quarterly trends combining hpc_charge_summary and comp_charge_summary
SELECT
...
ORDER BY YEAR(combined_data.activity_date) DESC, QUARTER(combined_data.activity_date) DESC, f.facility_name;
