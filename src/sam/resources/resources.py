...
class Resource(Base, TimestampMixin):
    ...
    facility_resources = relationship('FacilityResource', back_populates='resource', cascade='all, delete-orphan')
    machines = relationship('Machine', back_populates='resource', cascade='save-update, merge')
    ...
    queues = relationship('Queue', back_populates='resource', cascade='save-update, merge')
