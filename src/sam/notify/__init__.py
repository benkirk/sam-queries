...
_LAZY_EXPORTS = {
    ...
    'FACILITY_VARIANTS':          'sam.notify.kinds',
    'FAMILIES':                   'sam.notify.kinds',
    'NOTIFICATION_KINDS':         'sam.notify.kinds',
    'NotificationFamily':         'sam.notify.kinds',
    'NotificationKind':           'sam.notify.kinds',
    'addressing_scopes':          'sam.notify.kinds',
    'families':                   'sam.notify.kinds',
    'get_family':                 'sam.notify.kinds',
    ...
    'INJECTED_KEYS':              'sam.notify.samples',
    'VARIABLE_NOTES':             'sam.notify.samples',
    'palette':                    'sam.notify.samples',
    'preview_context':            'sam.notify.samples',
    'sample_context':             'sam.notify.samples',
    'sample_recipient':           'sam.notify.samples',
