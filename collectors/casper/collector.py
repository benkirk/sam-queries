    ...
    def _collect_node_data(self, data: dict):
        ...
        try:
            ...
            data.update({
                ...
                'gpu_nodes_total': 0,
                'gpu_nodes_available': 0, 'gpu_nodes_down': 0,
                'gpu_nodes_reserved': 0, 'gpu_count_total': 0,
                'gpu_count_allocated': 0,
                'gpu_count_idle': 0,
                'gpu_utilization_percent': 0,
                'viz_nodes_total': 0,
                'viz_nodes_available': 0, 'viz_nodes_down': 0,
                'viz_nodes_reserved': 0, 'viz_count_total': 0,
                'viz_count_allocated': 0,
                'viz_count_idle': 0,
                'viz_utilization_percent': 0,
                'memory_total_gb': 0.0,
