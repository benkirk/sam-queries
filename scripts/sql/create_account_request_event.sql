...
CREATE TABLE IF NOT EXISTS account_request_event (
  ...
  KEY        account_request_event_deadline (active, accounts_needed_by)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;

-- ---------------------------------------------------------------------------
-- The charset split. `name` is free text a sponsor typed; the identifiers stay
-- utf8mb3 so event_code lookups are not mixed-charset comparisons.
...
SELECT COUNT(DISTINCT INDEX_NAME) AS indexes_expect_4
